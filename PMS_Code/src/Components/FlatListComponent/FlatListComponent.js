...
export default class FlatListComponent extends React.Component {
    state = {
        data: [
            ...
            {
                title: 'Parth Rana',
                details: 'Integration Done for the Prtroject..',
                pic:
                    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCglgC3HBBR1077cPmES_UKP2CebigAOFDXPSLY9sTBSLimPemOFmfPeNpYOec8fL3IVA&usqp=CAU',
            },
        ],
    };
