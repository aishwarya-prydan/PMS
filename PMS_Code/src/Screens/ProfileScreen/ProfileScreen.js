        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.userInfoSection}>
                <View style={styles.row}>
                    <Icon name="map-marker" type="font-awesome" size={20} color="#777777" />
                    <Text style={{ color: '#777777', marginLeft: 20 }}>Ahemdabad, India</Text>
                </View>

                <View style={styles.row}>
                    <Icon name="phone" type="font-awesome" size={20} color="#777777" />
                    <Text style={{ color: '#777777', marginLeft: 20 }}>+91 9923475689 </Text>
                </View>

                <View style={styles.row}>
                    <Icon name="envelope" type="font-awesome" size={20} color="#777777" />
                    <Text style={{ color: '#777777', marginLeft: 20 }}>aishwarya21@gmail.com</Text>
                </View>
            </View>
